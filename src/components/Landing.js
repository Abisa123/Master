...
function Landing() {
    return (
        ...
        >
            <h3>Abisa<span>Zamboanga</span></h3>
        </Link>

        <nav>
            <a href="#pablo">Home</a>
            <a href="#pablo">Feature</a>
